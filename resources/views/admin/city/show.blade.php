            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{ url('admin/city' . '/' . $city->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> State Id </th><td> {{ $city->state_id }} </td></tr><tr><th> State </th><td> {{ $city->state }} </td></tr><tr><th> Capital </th><td> {{ $city->capital }} </td></tr>
                                </tbody>
                            </table>
                        </div>
