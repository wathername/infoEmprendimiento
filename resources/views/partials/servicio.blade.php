@if($company_data_servicio_status == null)
    <h1>Servio Comunitario</h1>
    <div>
        <a href="{{url('/company-data/Servicio-Comunitario')}}" class="btn btn-info btn-lg"><i class="fa fa-plus-circle"></i> Registar Datos</a>
    </div>
@else
    <div class="container">
        <div class="jumbotron">
            <div class="row">
                <div class="container" style="border-bottom:1px solid black">
                    <h3>Datos Registrados de Servicio Comunitario</h3>
                </div>
                <hr>
                <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8 col-lg-offset-2">
                    <ul class="container details">
                        ...
                        <hr>
                        @foreach($company_data_servicio as $company_data_pasantia)
                        ...
                        <hr>
                        @foreach($tutor_data_servicio as $tutor_data_pasantia)
