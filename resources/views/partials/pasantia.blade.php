    @if($company_data_pasantia_status == null)
        <h1>Pasantias</h1>
        <div>
            <a href="{{url('/company-data/Pasantias')}}" class="btn btn-info btn-lg"><i class="fa fa-plus-circle"></i> Registar Datos</a>
        </div>
    @else
        <div class="container">
            <div class="jumbotron">
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8 col-lg-offset-2">
                        <ul class="container details">
                                    ...
                                    <hr>
                                @foreach($company_data_pasantia as $company_data_pasantia)
                                ...
                                @endforeach
                                    ...
                                    <hr>
                                    @foreach($tutor_data_pasantia as $tutor_data_pasantia)
